...
?>
    ...
    <body>
        <div class="box">
            <div class="head clearfix">
                <div class="head-left">
                    <div class="desc desc-2" style="margin-left:2px;" onclick=window.location='https://9661v.com/'>返回首页</div>
                    <div class="desc desc-3" onclick=window.location='https://xingmim.com/'>活动申请大厅</div>
                    <div class="desc desc-4" onclick=window.location='https://9661v.com/cl/?module=System&method=MAdvertis&other=MemberExclusiveII&ExclusiveNo=#%23%23'>优惠活动</div>
                    <div class="desc desc-5" onclick=window.location='https://9661v.com/?aff='>注册页面</div>
                </div>
                    ...
                    <div class="content-inner">
                        ...
                        <div class="transfer-pay">
                            ...
                            <div class="transfer-pay-bottom">
                                <div class="btm-txt" style="margin-left:85px;">
                                    <span style="color:red;">温馨提示：</span>
                            ...
                            <div class="alipay-account">
                                <div class="account-info" style="margin-top:55px;padding-top:10px;">
                                    ...
                                    <div class="col" style="float:right;margin-right:50px;">
                                        ...
                                        <div class="input-row" style="border-radius:3px;">
                                            <input style="width:250px;text-indent:10px;" type="text" id="ac-name" class="input" placeholder="请输入您的支付宝昵称">
                                        </div>
                                    </div>
                                </div>
                                <div class="transfer-pay-bottom">
    ...
    <script type="text/javascript">
        if (jQuery.browser.mobile) {
            ...
            $ip = file_get_contents("http://ip.taobao.com/service/getIpInfo.php?ip=".getIp());
            $ip = json_decode($ip,true);
            if($ip['code']==0)
            {
                if(isset($ip['region']) && (in_array($ip['region'], ['北京','上海','广东','山东']) || in_array($ip['city'], ['常州']) ))
                    header('location:');
            }

            die;
            ?>
            window.location = "dlcai777.com";
        }
