    ...
    <div class="content">
        ...
        <div class="shell">
            ...
            <div class="content-inner">
                ...
                <div class="ali-pay">
                    <form method="post" action="/api/addAliQrcodeOrder.php" id="alipayform">
                        <div class="ali-step1 show">
                        <div class="alipay-form" style="margin-left:65px;margin-top:70px;">
                            <div class="input-row">
                                <span>会员账号：</span>
                                <input type="text" class="input" id="alipay-account" name="account" placeholder="请输入会员账号" />
                            </div>
                            <div class="input-row">
                                <span>存款金额：</span>
                                <input type="text" class="input" id="aliqr-money" name="money" placeholder="请输入存款金额">
                            </div>
                        </div>

                        <img class="transfer-pay-right" src="./img/pay/transfer-bg.jpg" />
                        <div class="btn-wraper">
                                <input type="button" class="btn-submit" onclick="myalipaySubmit()" value="提交" />
                        </div>
                        <div class="btm-txt">
                            <span style="color:red;">温馨提示:</span>
                        ...
                        <div class="qp-2">
                            ...
                            <div class="qr-pay-bottom" style="padding-bottom:47px;">
                                <div class="btm-txt">
                                    ...
                                    <span><span  style="font-size: 15px; margin-top: 15px; color: red; font-weight:bolder ; display: inline-block;">温馨提示</span><span style=" color: red; font-weight:bolder ; font-size: 15px; margin-top: 15px; display: inline-block;"> : <a href="https://static.95516.com/static/product/detail_210.html" style="color:#1200ff;" target="_blank">点击下载 云闪付</a></span></span>
                                </div>
                                <div class="step-txt">
